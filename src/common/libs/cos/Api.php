...
class Api
{
    ...
    private function updateBase(
        ...
        if (isset($custom_headers_array)) {
            $data['custom_headers'] = [];
            $this->addCustomerHeader($data['custom_headers'], $custom_headers_array);
        }
     ...
     * @return [type]  void
     */
    private function addCustomerHeader(&$data, &$customer_headers_array)
    {
